...
function on_field_label_changed(dom_field_block) {
  const dom_field_label_input = dom_field_block.querySelector(
    "[data-contentpath=label] input",
  );
  const dom_field_slug_input = dom_field_block.querySelector(
    "[data-contentpath=slug] input",
  );
...
class FormFieldBlockDefinition extends window.wagtailStreamField.blocks
  ...
  render(placeholder, prefix, initialState, initialError) {
    ...
    const dom_field_label = dom_field_block.querySelector(
      "[data-contentpath=label]",
    );
    dom_field_label.addEventListener("change", () =>
...
window.telepath.register(
  "forms.blocks.FormFieldBlock",
  FormFieldBlockDefinition,
);
