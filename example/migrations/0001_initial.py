...
import wagtail_form_mixins.emails.blocks
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outro', wagtail.fields.RichTextField(blank=True, default='Data collected in this form are saved by the LAAS lab in order to process your request.', verbose_name='Form conclusion text')),
                ('emails_to_send', wagtail.fields.StreamField([('email_to_send', 3)], block_lookup={0: ('wagtail.blocks.CharBlock', (), {'help_text': 'E-mail addresses of the recipients, separated by comma.', 'label': 'Recipient list', 'validators': [wagtail_form_mixins.emails.blocks.validate_emails]}), 1: ('wagtail.blocks.CharBlock', (), {'help_text': 'The subject of the e-mail.', 'label': 'Subject'}), 2: ('wagtail.blocks.RichTextBlock', (), {'help_text': 'The body of the e-mail.', 'label': 'Message'}), 3: ('wagtail.blocks.StructBlock', [[('recipient_list', 0), ('subject', 1), ('message', 2)]], {})}, default=[{'type': 'email_to_send', 'value': {'message': 'Bonjour {author.full_name},</p><p>Le {result.publish_date} à {result.publish_time}, l’utilisateur.ice {user.full_name} a complété.e le formulaire "{form.title}", avec le contenu suivant:</p><p></p><p>{result.data}</p><p></p><p>Bonne journée.', 'recipient_list': '{author.email}', 'subject': 'Nouvelle entrée pour le formulaire "{form.title}"'}}, {'type': 'email_to_send', 'value': {'message': 'Bonjour {user.full_name},</p><p>Vous venez de compléter le formulaire "{form.title}", avec le contenu suivant:</p><p></p><p>{result.data}</p><p></p><p>L’auteur.ice du formulaire en a été informé.</p><p>Bonne journée.', 'recipient_list': '{user.email}', 'subject': 'Confirmation de l’envoi du formulaire "{form.title}"'}}], verbose_name='E-mails to send after form submission')),
