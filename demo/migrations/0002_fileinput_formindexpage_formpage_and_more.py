...
import wagtail_form_plugins.token_validation.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_fields', wagtail.fields.StreamField([('singleline', 19), ('multiline', 22), ('email', 24), ('number', 28), ('url', 30), ('checkbox', 33), ('checkboxes', 36), ('dropdown', 39), ('multiselect', 41), ('radio', 39), ('date', 43), ('datetime', 45), ('hidden', 47), ('file', 49)], blank=True, block_lookup={0: ('wagtail.blocks.CharBlock', (), {'form_classname': 'formbuilder-field-block-label', 'help_text': 'Short text describing the field.', 'label': 'Label'}), 1: ('wagtail.blocks.CharBlock', (), {'help_text': 'Text displayed below the label to add more information.', 'label': 'Help text', 'required': False}), 2: ('wagtail.blocks.BooleanBlock', (), {'help_text': 'Check to make the field not editable by the user.', 'label': 'Disabled', 'required': False}), 3: ('wagtail_form_plugins.streamfield.blocks.RequiredBlock', (), {}), 4: ('wagtail.blocks.CharBlock', (), {'help_text': 'Single line text used to pre-fill the field.', 'label': 'Default value', 'required': False}), 5: ('wagtail.blocks.IntegerBlock', (), {'default': 0, 'help_text': 'Minimum amount of characters allowed in the field.', 'label': 'Min length'}), 6: ('wagtail.blocks.IntegerBlock', (), {'default': 255, 'help_text': 'Maximum amount of characters allowed in the field.', 'label': 'Max length'}), 7: ('wagtail.blocks.CharBlock', (), {'form_classname': 'formbuilder-beb-field', 'validators': [wagtail_form_plugins.conditional_fields.blocks.validate_field]}), 8: ('wagtail.blocks.ChoiceBlock', [], {'choices': [('eq', 'is equal to'), ('neq', 'is not equal to'), ('is', 'is'), ('nis', 'is not'), ('lt', 'is lower than'), ('lte', 'is lower or equal to'), ('ut', 'is upper than'), ('ute', 'is upper or equal to'), ('bt', 'is before than'), ('bte', 'is before or equal to'), ('at', 'is after than'), ('ate', 'is after or equal to'), ('ct', 'contains'), ('nct', 'does not contain'), ('c', 'is checked'), ('nc', 'is not checked')], 'form_classname': 'formbuilder-beb-operator'}), 9: ('wagtail.blocks.CharBlock', (), {'form_classname': 'formbuilder-beb-val-char', 'required': False}), 10: ('wagtail.blocks.DecimalBlock', (), {'form_classname': 'formbuilder-beb-val-num', 'required': False}), 11: ('wagtail.blocks.CharBlock', (), {'form_classname': 'formbuilder-beb-val-list', 'required': False}), 12: ('wagtail.blocks.DateBlock', (), {'form_classname': 'formbuilder-beb-val-date', 'required': False}), 13: ('wagtail.blocks.StructBlock', [[('field', 7), ('operator', 8), ('value_char', 9), ('value_number', 10), ('value_dropdown', 11), ('value_date', 12)]], {}), 14: ('wagtail.blocks.ListBlock', (13,), {'default': [], 'form_classname': 'formbuilder-beb-rules', 'label': 'Conditions'}), 15: ('wagtail.blocks.StructBlock', [[('field', 7), ('operator', 8), ('value_char', 9), ('value_number', 10), ('value_dropdown', 11), ('value_date', 12), ('rules', 14)]], {}), 16: ('wagtail.blocks.ListBlock', (15,), {'default': [], 'form_classname': 'formbuilder-beb-rules', 'label': 'Conditions'}), 17: ('wagtail.blocks.StructBlock', [[('field', 7), ('operator', 8), ('value_char', 9), ('value_number', 10), ('value_dropdown', 11), ('value_date', 12), ('rules', 16)]], {}), 18: ('wagtail.blocks.ListBlock', (17,), {'default': [], 'form_classname': 'formbuilder-field-block-rule', 'label': 'Visibility condition', 'max_num': 1}), 19: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 4), ('min_length', 5), ('max_length', 6), ('rule', 18)]], {}), 20: ('wagtail.blocks.TextBlock', (), {'help_text': 'Multi-line text used to pre-fill the field.', 'label': 'Default value', 'required': False}), 21: ('wagtail.blocks.IntegerBlock', (), {'default': 1024, 'help_text': 'Maximum amount of characters allowed in the field.', 'label': 'Max length'}), 22: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 20), ('min_length', 5), ('max_length', 21), ('rule', 18)]], {}), 23: ('wagtail.blocks.EmailBlock', (), {'help_text': 'E-mail used to pre-fill the field.', 'label': 'Default value', 'required': False}), 24: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 23), ('rule', 18)]], {}), 25: ('wagtail.blocks.DecimalBlock', (), {'help_text': 'Number used to pre-fill the field.', 'label': 'Default value', 'required': False}), 26: ('wagtail.blocks.IntegerBlock', (), {'help_text': 'Minimum number allowed in the field.', 'label': 'Min value', 'required': False}), 27: ('wagtail.blocks.IntegerBlock', (), {'help_text': 'Maximum number allowed in the field.', 'label': 'Max value', 'required': False}), 28: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 25), ('min_value', 26), ('max_value', 27), ('rule', 18)]], {}), 29: ('wagtail.blocks.URLBlock', (), {'help_text': 'URL used to pre-fill the field.', 'label': 'Default value', 'required': False}), 30: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 29), ('rule', 18)]], {}), 31: ('wagtail_form_plugins.streamfield.blocks.RequiredBlock', ('the box must be checked',), {}), 32: ('wagtail.blocks.BooleanBlock', (), {'help_text': 'If checked, the box will be checked by default.', 'label': 'Checked', 'required': False}), 33: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 31), ('initial', 32), ('rule', 18)]], {}), 34: ('wagtail_form_plugins.streamfield.blocks.RequiredBlock', ('at least one box must be checked',), {}), 35: ('wagtail_form_plugins.streamfield.blocks.ChoicesList', (wagtail.blocks.StructBlock([('label', wagtail.blocks.CharBlock(form_classname='formbuilder-choice-label', label='Label')), ('initial', wagtail.blocks.BooleanBlock(label='Checked', required=False))]),), {}), 36: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 34), ('choices', 35), ('rule', 18)]], {}), 37: ('wagtail_form_plugins.streamfield.blocks.RequiredBlock', ('an item must be selected',), {}), 38: ('wagtail_form_plugins.streamfield.blocks.ChoicesList', (), {}), 39: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 37), ('choices', 38), ('rule', 18)]], {}), 40: ('wagtail_form_plugins.streamfield.blocks.RequiredBlock', ('at least one item must be selected',), {}), 41: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 40), ('choices', 38), ('rule', 18)]], {}), 42: ('wagtail.blocks.DateBlock', (), {'help_text': 'Date used to pre-fill the field.', 'label': 'Default value', 'required': False}), 43: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 42), ('rule', 18)]], {}), 44: ('wagtail.blocks.DateTimeBlock', (), {'help_text': 'Date and time used to pre-fill the field.', 'label': 'Default value', 'required': False}), 45: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 44), ('rule', 18)]], {}), 46: ('wagtail.blocks.CharBlock', (), {'help_text': 'Hidden text used to pre-fill the field.', 'label': 'Default value', 'required': False}), 47: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('initial', 46), ('rule', 18)]], {}), 48: ('wagtail.blocks.MultipleChoiceBlock', [], {'choices': [('pdf', 'pdf'), ('jpg', 'jpg'), ('jpeg', 'jpeg'), ('png', 'png')], 'label': 'Allowed file extensions'}), 49: ('wagtail.blocks.StructBlock', [[('label', 0), ('help_text', 1), ('disabled', 2), ('required', 3), ('allowed_extensions', 48), ('rule', 18)]], {})}, verbose_name='Form fields')),
            ...
            bases=(wagtail_form_plugins.token_validation.models.TokenValidationFormMixin, wagtail.contrib.forms.models.FormMixin, 'wagtailcore.page', models.Model),
        ),
        migrations.CreateModel(
